"""Clicking Launch on a CC account WITH a stored token skips /register."""
...
def test_cc_account_with_token_skips_register(qapp, monkeypatch, tmp_path):
    ...
    cm.set_launcher_token(acct_id, "existing-tok")

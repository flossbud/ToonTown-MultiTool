...
class MultiToonTool(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(QRect(100, 100, 500, 650))
        ...
        if self.settings_manager.get("show_debug_tab", False):
            self.tabs.addTab(self.debug_tab, "Logs")
    ...
    def normalize_key(self, key):
        """Convert a pynput key to the string name input_service expects."""
        PYNPUT_NAME_MAP = {
            "space":     "space",
            "enter":     "Return",
            "esc":       "Escape",
        ...
        if name:
            return PYNPUT_NAME_MAP.get(name.lower(), None)
        return None

    def on_global_key_press(self, key):
        try:
            # Preset hotkeys: Ctrl+1-5
            ...
            # Feed into input service event queue
